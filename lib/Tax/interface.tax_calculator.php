...
interface tax_calculator
{
    ...
    public function set_source_location(company_address $addr);

    public function set_dest_location(\xt_address $addr);

    public function calculate_taxes(Cart\cartitem $item);
